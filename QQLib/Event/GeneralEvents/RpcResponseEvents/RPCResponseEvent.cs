...
namespace QQLib.Event.GeneralEvents.RpcResponseEvents
{

    public class RPCResponseEvent : Event
    {
        ...
        public RPCResponseEvent(INetClient client, NetworkEvent netEvent, BSONObject bson)
        {
            this._client = client;
